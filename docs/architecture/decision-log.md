...
|------|----------|-----------|
| 2026-07-16 | Portable feature module under `src/features/learner-lifecycle` | Enables later portal integration without rewrite |
...
| 2026-07-16 | Primary operational route `/learners/lifecycle` | Matches manifesto; integrates as portal section later |
...
| 2026-07-17 | Employer concerns routed **GTA-first**; internal notes hidden from employer views | Learner protection principle |
