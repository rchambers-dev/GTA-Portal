...
/** Legacy child path → canonical learner URL with ?tab= */
export default async function LearnerEvidenceRedirect({
  params,
  searchParams,
}: Props) {
  ...
  redirect(learnerRecordHref(learnerId, { tab: "evidence", from }));
}
