...
/** Legacy child path → canonical apprentice URL with ?tab= */
export default async function ApprenticeEvidenceRedirect({
  params,
  searchParams,
}: Props) {
  ...
  redirect(apprenticeRecordHref(apprenticeId, { tab: "evidence", from }));
}
