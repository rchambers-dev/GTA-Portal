...
function TaskRow({
  ...
  const [notes, setNotes] = useState(progress.learnerNotes);
      ...
      {open ? (
        <div className={styles.ceaTaskPanel}>
              ...
              {task.relatedTeaching.moduleId ? (
                <>
                  ...
                  <Link
                    ...
                    href={`/learner/modules/${task.relatedTeaching.moduleId}`}
                  >
                    View coverage
                  </Link>
                </>
          ...
          {progress.status === "signed_off" ? (
            <p className={styles.meta}>
              {progress.learnerNotes || "No learner notes recorded."}
            </p>
          ) : (
            <>
  ...
  return (
    <section className={styles.ceaGroup}>
      ...
      >
        ...
        <span className={styles.ceaTaskMeta}>
          <LearnerStatusChip tone={complete ? "green" : "amber"}>
  ...
  return (
    <section className={styles.ceaGroup}>
      ...
      >
        ...
        <span className={styles.ceaTaskMeta}>
          <LearnerStatusChip tone={done === items.length ? "green" : "neutral"}>
  ...
  return (
    <section className={`${styles.ceaGroup} ${styles.ceaGatewayBlock}`}>
      ...
      >
        ...
        <span className={styles.ceaTaskMeta}>
          <LearnerStatusChip tone="blue">Gateway</LearnerStatusChip>
          <span className={styles.otjChevron} aria-hidden>
            {open ? "▾" : "▸"}
          </span>
        </span>
...
export function LearnerCeaScreen() {
  const pack = AUTOCARE_CEA_PACK;
  const [state, setState] = useState<CeaLearnerState>(ALEX_CEA_STATE);
      ...
      <div className={styles.stack}>
        <div className={styles.ceaOverview}>
          <div>
            ...
            <p className={styles.meta}>
              Learner: {ALEX_PROFILE.displayName} · Tutor: {ALEX_PROFILE.tutorName}
            </p>
          </div>
