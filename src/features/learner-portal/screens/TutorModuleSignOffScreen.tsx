  ...
  return (
    <article className={styles.card}>
      <div className={styles.cardMain}>
        <p className={styles.learner}>{item.learnerName}</p>
      ...
      <div className={styles.cardSide}>
        <LearnerStatusChip tone={toneFor(status)}>
          {labelFor(status)}
        </LearnerStatusChip>
        ...
        {status === "redo_requested" ? (
          <p className={styles.stubNote}>Stub: learner notified to resubmit</p>
        ) : null}
    ...
    <div className={styles.root}>
      <header className={styles.header}>
        ...
        <p className={styles.lead}>
          Everything that needs covering or signing off for your learners —
