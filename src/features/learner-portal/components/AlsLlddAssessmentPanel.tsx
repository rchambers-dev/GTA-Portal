  ...
  return (
    <div className={styles.stack}>
      ...
      <section className={styles.otjForm}>
        <h2 className={styles.sectionTitle}>Linked learner</h2>
      ...
      {state.requiresAlsAssessment === "yes" ? (
        <section className={styles.otjForm}>
          ...
          <YesNoField
            label="1. Does the learner require a full Learning Support Assessment to review barriers to learning?"
          ...
          <p className={styles.metaBlock}>
            If question 2 is Yes, the learner can continue and work on actions
