    ...
    <div className={styles.stack}>
      ...
      <section className={styles.otjForm}>
        <h2 className={styles.sectionTitle}>
          2 · Learner eligibility — identity and right to work
        </h2>
        <YesNoField
          label="2.1 Fully completed learner enrolment form, signed declaration, and confirmed right to work in England?"
        ...
        />
        <YesNoField
          label="2.2 Learner is 16+ and/or will start after the last Friday in June of the academic year of their 16th birthday?"
      ...
      <section className={styles.otjForm}>
        ...
        <YesNoField
          label="9.1 Learner indicated LLDD via interview and/or enrolment that may require an Additional Learning Support assessment?"
          value={state.needsAlsAssessment}
          disabled={locked}
          onChange={(value) => patch({ needsAlsAssessment: value })}
        />
        <YesNoField
          label="9.2 Learner indicated LLDD that may require a health and safety risk assessment review?"
        ...
        {(state.needsAlsAssessment === "yes" ||
          ...
          <Link
            href="/learner/documents/eligibility/1.7"
