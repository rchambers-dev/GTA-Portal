import type { CeaLearnerState, CeaPackDef, CeaTaskDef } from "./types";
...
/**
 * Seeded from MV13.1 Autocare Learner Personal Tracking v1.8.
...
export const AUTOCARE_CEA_PACK: CeaPackDef = {
  ...
  title: "Autocare Learner Personal Tracking",
  version: "v1.8",
  standardCode: "ST0499",
...
function prog(
  ...
  status: CeaLearnerState["progress"][string]["status"],
  extra?: Partial<CeaLearnerState["progress"][string]>,
): CeaLearnerState["progress"][string] {
  return {
    taskId,
    kind,
    additionalEnabled: kind === "additional",
    status,
    learnerNotes: extra?.learnerNotes ?? "",
...
export const ALEX_CEA_STATE: CeaLearnerState = {
  ...
  progress: {
    "g1-t1": prog("g1-t1", "mandatory", "signed_off", {
      ...
      learnerNotes: "PPE, COSHH, and workshop walkthrough completed in college.",
    }),
    ...
    "g2-t1": prog("g2-t1", "mandatory", "signed_off", {
      ...
      learnerNotes: "Located HV components on training vehicle under supervision.",
    }),
    ...
    "g3-t4": prog("g3-t4", "mandatory", "ready_to_assess", {
      ...
      learnerNotes: "Balanced all four wheels in college — ready for teacher sign-off.",
    }),
    "g3-t2": prog("g3-t2", "additional", "ready_to_assess", {
      readyAt: "2026-07-19T17:00:00Z",
      learnerNotes: "Puncture repair completed at Riverside Autocare — ready for employer sign-off.",
    }),
    "g4-t1": prog("g4-t1", "mandatory", "in_progress", {
      learnerNotes: "Front discs and pads practice started in workshop.",
    }),
