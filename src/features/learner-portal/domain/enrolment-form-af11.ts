/**
 * AF1.1 Learner Apprenticeship Enrolment Form 25-26 v1.1
 * Maps to ADM14.0 reference 1.2 — Learner Enrolment Form.
 */
...
export const AF11_FORM_TITLE = "Learner Apprenticeship Enrolment Form";
...
export type EnrolmentFormAf11State = {
  ...
  /** Unique Learner Number — required for LRS PLR retrieval */
  uln: string;
  age: string;
