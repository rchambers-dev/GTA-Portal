...
export function createSeedSnapshot(): AdminStoreSnapshot {
  ...
  const enrolments: AdminLearnerEnrolment[] = [
    {
      ...
      standardCode: "ST0499",
      cohortId: "cohort-autocare-jul-2025",
      ...
      originalPlannedEndDate: "2027-08-31",
      programmeYear: 2,
      programmeWeek: 56,
      attendancePercent: 94,
      actualProgressPercent: 48,
      collegeDays: "Mon, Tue",
      notes: "Demo learner — halfway through (Block 6 / week 56).",
      createdAt: now,
      updatedAt: now,
    },
    {
    ...
    },
    {
      ...
      programmeName: "Autocare Level 2",
      standardCode: "ST0499",
      cohortId: "cohort-autocare-jul-2026",
      employerId: "emp-riverside",
      employerName: "Riverside Autocare",
      workplaceContact: "Priya Shah",
      mentorName: "Priya Shah",
      ...
      originalPlannedEndDate: "2029-01-13",
      programmeYear: null,
      programmeWeek: null,
  ...
  const cohorts: AdminCohortRecord[] = [
    ...
    {
      id: "cohort-autocare-jul-2025",
      name: "Autocare L2 · Jul 2025",
      programmeId: "prog-autocare-l2",
      programmeName: "Autocare Level 2",
      standardCode: "ST0499",
      standardVersion: "1.3",
      enrolmentOpensDate: "2025-04-01",
      startDate: "2025-07-08",
      expectedEndDate: "2027-08-31",
      teachingGroup: "Mon–Tue Group A2",
      collegeDays: "Mon, Tue",
      tutorName: "Daniel Turner",
      status: "active",
      notes:
        "Demo mid-programme cohort — Alex is week 56 / Block 6 (halfway).",
      createdAt: now,
      updatedAt: now,
    },
    {
      id: "cohort-autocare-jan-2026",
      name: "Autocare L2 · Jan 2026",
      programmeId: "prog-autocare-l2",
      programmeName: "Autocare Level 2",
      standardCode: "ST0499",
      standardVersion: "1.3",
      enrolmentOpensDate: "2025-10-01",
      startDate: "2026-01-12",
      expectedEndDate: "2028-07-12",
      teachingGroup: "Mon–Tue Group B",
      collegeDays: "Mon, Tue",
      tutorName: "Daniel Turner",
      status: "active",
      notes: "Quarterly intake · Skills England v1.3.",
      createdAt: now,
      updatedAt: now,
    },
    {
      id: "cohort-autocare-apr-2026",
      name: "Autocare L2 · Apr 2026",
      programmeId: "prog-autocare-l2",
      programmeName: "Autocare Level 2",
      standardCode: "ST0499",
      standardVersion: "1.3",
      enrolmentOpensDate: "2026-01-05",
      startDate: "2026-04-13",
      expectedEndDate: "2028-10-13",
      teachingGroup: "Mon–Tue Group C",
      collegeDays: "Mon, Tue",
      tutorName: "Daniel Turner",
      status: "active",
      notes: "Quarterly intake · Skills England v1.3.",
    ...
    {
      id: "cohort-autocare-jul-2026",
      name: "Autocare L2 · Jul 2026",
      programmeId: "prog-autocare-l2",
      programmeName: "Autocare Level 2",
      standardCode: "ST0499",
      standardVersion: "1.3",
      enrolmentOpensDate: "2026-04-01",
      startDate: "2026-07-13",
      expectedEndDate: "2029-01-13",
      teachingGroup: "Mon–Tue Group D",
      collegeDays: "Mon, Tue",
      tutorName: "Daniel Turner",
      status: "active",
      notes: "Quarterly intake · current new-starter cohort (v1.3).",
      createdAt: now,
      updatedAt: now,
    },
    {
      id: "cohort-autocare-oct-2026",
      name: "Autocare L2 · Oct 2026",
      programmeId: "prog-autocare-l2",
      programmeName: "Autocare Level 2",
      standardCode: "ST0499",
      standardVersion: "1.3",
      enrolmentOpensDate: "2026-07-01",
      startDate: "2026-10-12",
      expectedEndDate: "2029-04-12",
      teachingGroup: "Mon–Tue Group E",
      collegeDays: "Mon, Tue",
      tutorName: "Daniel Turner",
      status: "planned",
      notes: "Next quarterly intake — enrolment open ahead of start.",
      createdAt: now,
      updatedAt: now,
    },
    {
  ...
  const users: AdminPortalUser[] = [
    ...DEMO_ACCOUNTS.map((account) => {
      ...
      return {
        ...
        programmeStartDate:
          account.id === "alex-morgan" ? "2025-07-08" : null,
