 ...
 */
export function LifecycleBoardScreen({ board, selectedApprenticeId }: Props) {
  const q = board.query;
  ...
  return (
    <div className={styles.root}>
      <header className={styles.pageHeader}>
        <div>
          <p className={styles.eyebrow}>Weekly Apprentice Lifecycle</p>
          <h1 className={styles.title}>Apprentice Lifecycle Board</h1>
        </div>
      ...
      <LifecycleBoardView board={board} selectedApprenticeId={selectedApprenticeId} />
    </div>
  );
}
