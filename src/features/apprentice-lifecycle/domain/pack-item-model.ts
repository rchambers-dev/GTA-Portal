/**
 * Progressive pack item model for the Apprentices page.
 *
 * Intake stays personal-details only. Everything here is entered and amended
 * on Apprentices as the apprentice moves through the programme.
 *
...
/** Editable payload stored per apprentice + ADM14 reference. */
...
const DOCUMENT_FIELDS: PackFieldDef[] = [
  ...
  },
  {
    ...
    label: "Source",
    type: "text",
    placeholder: "e.g. Employer email, apprentice upload…",
  },
];
...
const SCHEMA_BY_REF: Record<string, PackItemSchema> = {
  "1.1": {
    ...
    fields: formFields(
      {
        key: "ilrReference",
        label: "ILR apprentice reference",
        type: "text",
      },
