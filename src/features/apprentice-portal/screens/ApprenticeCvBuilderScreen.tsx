...
const STORAGE_KEY = "gta.apprentice.cv.v7";
...
export function ApprenticeCvBuilderScreen() {
    ...
    queueMicrotask(() => {
      try {
        const raw =
          ...
          window.localStorage.getItem("gta.apprentice.cv.v6") ||
          window.localStorage.getItem("gta.apprentice.cv.v5");
        if (raw) {
  ...
  /** Only surface an error once the apprentice has left the field, or tried to export. */
