      ...
      <div className={styles.stack}>
        <div className={styles.otjSummaryCard} data-tone="amber">
          ...
          <p className={styles.metaBlock}>
            Complete <strong>AF1.1 Apprentice Enrolment Form</strong> and choose
          ...
          <p className={styles.glanceHint}>
            <Link href="/apprentice/documents/eligibility/1.2" className={styles.linkish}>
              Open enrolment form →
            </Link>
          </p>
        </div>
    ...
    return (
      <div className={styles.stack}>
        <div className={styles.otjHealthBar} data-health="behind">
          ...
          <ApprenticeStatusChip tone="amber">Stub</ApprenticeStatusChip>
        </div>
  ...
  return (
    <div className={styles.stack}>
      ...
      <section className={styles.otjForm}>
        <h2 className={styles.sectionTitle}>Apprentice summary</h2>
        <div className={styles.formGrid}>
          <label className={styles.field}>
            Apprentice name
            <input
              value={state.apprenticeName}
              disabled={locked}
              onChange={(e) => patch({ apprenticeName: e.target.value })}
            />
          </label>
          <label className={styles.field}>
            Date of birth
      ...
      {programme.eligibilityQuestions.length > 0 ? (
        <section className={styles.otjForm}>
          <h2 className={styles.sectionTitle}>Apprentice eligibility check</h2>
      ...
      <section className={styles.otjForm}>
        ...
        <fieldset className={styles.otjFieldset} disabled={locked}>
          <legend>Has RPLE been identified for this apprentice?</legend>
          <div className={styles.otjPresetRow}>
            {(["yes", "no"] as const).map((option) => (
              <button
                key={option}
