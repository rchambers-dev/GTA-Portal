...
export function listShareablePortalLinks(): ChatPortalLinkOption[] {
  return [
    ...
    },
    {
      ...
      detail: "Group task documents and progression (groups spine)",
      actionLabel: "Open Progress",
      area: "Tracking",
      keywords: ["tracking", "cea", "task", "groups", "progress"],
      audience: ["anyone"],
    },
    {
      id: "tracking-tyres",
      type: "portal_link",
      href: "/apprentice/progress/g3-t1",
      title: "Progress · Remove and install tyres",
    ...
    },
    {
      ...
      title: "Task sign-off",
      detail: "CEA documents waiting for tutor review",
    ...
    {
      id: "employer-cea-queue",
      type: "portal_link",
      href: "/employer/cea-sign-offs",
      title: "Workplace sign-off",
      detail: "Additional workplace documents waiting for employer review",
      actionLabel: "Open queue",
      area: "Approvals",
      keywords: ["employer", "sign-off", "workplace", "cea"],
