...
export const ALEX_PROFILE: ApprenticePortalProfile = {
...
export function collectMissedLearningItems(
  days: ApprenticeAttendanceDay[] = ALEX_ATTENDANCE_DAYS,
 ...
 */
export const ALEX_ATTENDANCE_BREAKDOWN: ApprenticeAttendanceBreakdownItem[] = [
  {
    status: "attended",
    label: "Attended",
    count: 28,
...
export function summariseAlexAttendance(
  breakdown: ApprenticeAttendanceBreakdownItem[] = ALEX_ATTENDANCE_BREAKDOWN,
) {
...
export const ALEX_MODULES: ApprenticeModuleRow[] = [
  {
    id: "m1",
    code: "MV-101",
...
export function getAlexModuleDetail(moduleId: string): ApprenticeModuleDetail | null {
...
export const ALEX_OTJ_ENTRIES: ApprenticeOtjEntry[] = [
  {
    id: "otj-1",
    entryNumber: 1,
...
export const ALEX_REVIEW_DETAILS: ApprenticeReviewDetail[] = [
  {
    ...
    prepareHref: "/apprentice/learning",
  ...
  },
  {
    ...
    href: "/apprentice/reviews/rev-alex-last",
    mentorName: ALEX_PROFILE.mentorName,
    programmeName: ALEX_PROFILE.programmeName,
    employerName: ALEX_PROFILE.employerName,
    summary:
...
export const ALEX_REVIEWS: ApprenticeReviewSummary[] = ALEX_REVIEW_DETAILS.map(
  ({
    id,
    reviewDate,
    type,
...
export function getAlexReview(reviewId: string): ApprenticeReviewDetail | null {
  return ALEX_REVIEW_DETAILS.find((review) => review.id === reviewId) ?? null;
}

export const ALEX_ATTENDANCE_DAYS: ApprenticeAttendanceDay[] = [
  {
    date: "2026-07-14",
    dayName: "Tuesday",
    session: "Workshop AM",
  ...
  thisWeek: [
    {
      ...
      kind: "college",
      href: "/apprentice/college-tasks/block-1-task-3",
      hrefLabel: "Open task",
    },
    {
      id: "lp-2",
      ...
      kind: "college",
      href: "/apprentice/college-tasks/block-1-task-4",
      hrefLabel: "Open task",
    },
    {
      id: "lp-3",
  ...
  lookingAhead: [
    {
      ...
      kind: "college",
      href: "/apprentice/college-tasks/block-1-task-5",
...
export function getAlexActiveLearningModules(): ApprenticeModuleDetail[] {
  return ALEX_LEARNING.activeModuleIds
    .map((id) => getAlexModuleDetail(id))
    .filter((m): m is ApprenticeModuleDetail => m != null);
}
...
export function getAlexProfile(): ApprenticePortalProfile {
  return ALEX_PROFILE;
}
