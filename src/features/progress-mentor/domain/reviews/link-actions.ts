...
export function createActionFromReviewAgreement(input: {
  ...
  const record: ActionRecord = {
    ...
    title: input.title,
    description: input.description,
    learnerId: input.review.learnerId,
    learnerName: input.review.learnerName,
    ...
    sourceLabel: `${input.review.reviewType} · ${input.review.reviewDate} · ${input.review.learnerName}`,
