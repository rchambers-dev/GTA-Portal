 ...
 */
export function ManagementLearnerBragScreen() {
  ...
  useEffect(() => {
    const q = new URLSearchParams(window.location.search).get("learner");
    if (q) setLearnerId(q);
  }, []);
  ...
  }, [cohortStartDate, deliveryEnd, storeLearnerId, taskSnap]);
          ...
          <label className={styles.field} style={{ minWidth: "16rem" }}>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                url.searchParams.set("learner", e.target.value);
        ...
        {enrolment ? (
          <div className={deliveryStyles.bragBoard}>
            ...
            >
              ...
              >
                {overall ? (
                  <LearnerStatusChip tone={overall} size="lg">
                    {bragLabel(overall)}
                  </LearnerStatusChip>
                ) : (
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {brag ? (
                        <LearnerStatusChip tone={brag as ProgressionBrag}>
                          {bragShortLabel(brag)}
                        </LearnerStatusChip>
                      ) : (
                        <LearnerStatusChip tone="neutral">
                          Not due yet
                        </LearnerStatusChip>
                      )}
                  ...
                  {open ? (
                    <ul className={deliveryStyles.taskList}>
                      {tasks.map((task) => {
                        ...
                        const href = `/management/learner-brag/task/${task.id}?learner=${encodeURIComponent(learnerId)}`;
                          ...
                          <li key={task.id}>
                            {canOpen ? (
                              ...
                              >
                                ...
                                <LearnerStatusChip tone={notStartedTone}>
