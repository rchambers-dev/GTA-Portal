    ...
    return filterSections(session, [
      {
        items: [
          ...
          { href: "/learner/cea", label: "CEA tasks", permission: PERMISSIONS.LEARNER_MODULES_VIEW },
    ...
    return filterSections(session, [
      {
        items: [
          ...
          { href: "/management/accounts", label: "Account Setup", permission: PERMISSIONS.ADMIN_USERS_MANAGE },
