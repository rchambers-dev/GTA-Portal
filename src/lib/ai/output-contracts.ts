...
export const AI_OUTPUT_CONTRACTS: Partial<Record<AiFeatureKey, string>> = {
  ...
  "cv.improve_bullets": [
    ...
    "You may use module titles from learner.modules_public to sharpen wording when present.",
    "Do not invent achievements the learner did not provide.",
  ...
  "cv.suggest_experience_bullets": [
    ...
    "Ground each bullet in completed or in-progress modules from learner.modules_public.",
  ...
  "cv.improve_education": [
    ...
    "Use completed and in-progress module titles from learner.modules_public when present.",
